...
public class SimulatorEngine {
     ...
     * @param output store generated events in a file
     * @throws SimulatorException unable to create ras event
     */
    void publishRasEvents(@NotNull final String regexLocation, @NotNull final String regexLabel, @NotNull final String burst, final String timeDelayMus, final String randomiserSeed, final String numOfEvents, final String output) throws SimulatorException {
        Map<String, String> parameters = new HashMap<>();
        parameters.put("location-regex", regexLocation);
        ...
        try {
            ...
            if (ExistsLocationsMatchedRegex(regexLocation, EVENT_TYPE.RAS) && ExistsMatchedRegexLabel(regexLabel, EVENT_TYPE.RAS)) {
                List<ForeignEvent> rasEvents = system_.publishRASEventsForLocation(numOfEvents_, randomiserSeed_);
                Map<Long, List<ForeignEvent>> events = new HashMap<>();
