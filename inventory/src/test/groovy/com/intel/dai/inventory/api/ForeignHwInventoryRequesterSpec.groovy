...
class ForeignHwInventoryRequesterSpec extends Specification {
    ...
    def "getHwInventory - xname"() {
        ...
        when:
        def res = invRequester.getHwInventory("x0","anyfile")
    ...
    def "interpreteQueryHWInvTreeResult"() {
        ...
        def blockingResult = new BlockingResult(code, responseDocument, requestInfo)
        expect:
        invRequester.interpreteQueryHWInvTreeResult(uri, blockingResult, outputFile) == status

        where:
        code    | responseDocument      | requestInfo                       | outputFile                    || status
        200     | "hw inv tree"         | new RequestInfo(null, null, null) | "build/tmp/fakeHwInv.json"    || 0
        200     | "hw inv tree"         | new RequestInfo(null, null, null) | null                          || 1
        400     | "hw inv tree"         | new RequestInfo(null, null, null) | "build/tmp/fakeHwInv.json"    || 1
    }
}
