...
public class HWInvDbClientCLI {
    ...
    private int run(HWInvApi client) throws InterruptedException, IOException, DataStoreException {
        switch (mode) {
            ...
            case "c2d":
                ...
                return client.ingest(canonicalInputFileName);
    ...
    private int ingest(HWInvApi client, String inputFileName, boolean update) throws InterruptedException, IOException, DataStoreException {
        final String canonicalTreeFileName = inputFileName + ".tr";
        HWInvUtilImpl util = new HWInvUtilImpl();
        HWInvTranslator tr = new HWInvTranslator(inputFileName, canonicalTreeFileName, util);
        String locationName = tr.foreignToCanonical();
