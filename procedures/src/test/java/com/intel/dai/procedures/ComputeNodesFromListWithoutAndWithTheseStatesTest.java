...
public class ComputeNodesFromListWithoutAndWithTheseStatesTest {
    class MockComputeNodesFromListWithoutAndWithTheseStates extends ComputeNodesFromListWithoutAndWithTheseStates {
        @Override
    ...
    @Test
    public void run() {
        ComputeNodesFromListWithoutAndWithTheseStates proc = new MockComputeNodesFromListWithoutAndWithTheseStates();
        proc.run(new String[] {}, new String[] {});
        proc.run(new String[] {"Lctn"}, new String[] {"State"});
    }
}
