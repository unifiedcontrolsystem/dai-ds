...
public class DiagListOfNonActiveDiagsAtTimeTest {
    class MockDiagListOfNonActiveDiagsAtTime extends DiagListOfNonActiveDiagsAtTime {
        @Override
    ...
    @Test
    public void run() {
        MockDiagListOfNonActiveDiagsAtTime proc = new MockDiagListOfNonActiveDiagsAtTime();
