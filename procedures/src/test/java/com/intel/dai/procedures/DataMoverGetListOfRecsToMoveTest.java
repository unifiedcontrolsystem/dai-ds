...
public class DataMoverGetListOfRecsToMoveTest {
    class MockDataMoverGetListOfRecsToMove extends DataMoverGetListOfRecsToMove {
        @Override
    ...
    @Test
    public void run() {
        DataMoverGetListOfRecsToMove proc = new MockDataMoverGetListOfRecsToMove();
        proc.run(0L, 0L);
    }
}
