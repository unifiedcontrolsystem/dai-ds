...
public class ServiceNodeSetStateTest {
    class MockServiceNodeSetState extends ServiceNodeSetState {
        @Override
    ...
    @Test
    public void run() {
        MockServiceNodeSetState proc = new MockServiceNodeSetState();
        proc.run("Lctn", "A", 40000L, "RAS", 9999L);
    }
    ...
    public void run3() {
        MockServiceNodeSetState proc = new MockServiceNodeSetState();
        proc.run("Lctn", "A", 50000L, "RAS", 9999L);
    }
}
