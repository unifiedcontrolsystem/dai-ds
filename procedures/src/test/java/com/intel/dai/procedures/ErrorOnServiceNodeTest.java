        ...
        public VoltTable[] voltExecuteSQL(boolean value) {
            ...
            if(!doZeroRows) {
                result[0].addRow("Lctn", 1L, "HostName", "BootImageId", "IpAddr", "MacAddr",
                        "BmcIpAddr", "BmcMacAddr", "BmcHostName", "Owner", "Agg01", new TimestampType(Date.from(Instant.ofEpochMilli(40L))), "Constraint1", new TimestampType(Date.from(Instant.ofEpochMilli(40L))));
            }
            return result;
        }
