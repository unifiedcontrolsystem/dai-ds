...
public class ComputeNodeDiscovered extends ComputeNodeCommon {
    ...
    public long run(String sNodeLctn, long lTsInMicroSecs, String sReqAdapterType, long lReqWorkItemId) throws VoltAbortException
    {
        ...
        if (aNodeData[0].getRowCount() == 0) {
            throw new VoltAbortException("ComputeNodeDiscovered - there is no entry in the ComputeNode table for the specified " +
