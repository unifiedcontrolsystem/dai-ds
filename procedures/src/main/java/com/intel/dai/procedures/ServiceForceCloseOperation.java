...
/**
 * Handle the database processing that is necessary when a service operation is forceClosed.
 * NOTE:
 *
 *  Input parameter:
...
public class ServiceForceCloseOperation extends VoltProcedure {
    ...
    public long run(long lServiceId, String sLctn ) throws VoltAbortException {
        ...
        //--------------------------------------------------------------------------------------
        // Update the ServiceOperation_History to indicate forceclose of this serviceoperation.
        //--------------------------------------------------------------------------------------
