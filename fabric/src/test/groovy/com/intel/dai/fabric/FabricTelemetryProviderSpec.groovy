...
class FabricTelemetryProviderSpec extends Specification {
    def configFile_ = new File("./build/tmp/FabricTelemetryProviderSpec.json")
    def factory_
    def adapter_
    def underTest_
    def workQueue_
    ...
    void setup() {
        ...
        underTest_ = new FabricTelemetryProvider("127.0.0.1", Mock(Logger), factory_, adapter_)
