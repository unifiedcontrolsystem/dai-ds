...
public class EventSimRasEventProviderForeignBusTest {
    static class MockEventSimRasEventProviderForeignBus extends EventSimRasEventProviderForeignBus {
        MockEventSimRasEventProviderForeignBus(Logger logger) { super(logger); initialize(); }
    ...
    public void setUp() throws Exception {
        MockEventSimRasEventProviderForeignBus.returnNull_ = false;
        MockEventSimRasEventProviderForeignBus.loadBad_ = false;
        EventSimRasEventProviderForeignBus.Accumulator.suppressionCount_ = 3;
        EventSimRasEventProviderForeignBus.Accumulator.suppressionWindowsSeconds_ = 10;
        transformer_ = new MockEventSimRasEventProviderForeignBus(mock(Logger.class));
    ...
    public void getStreamFails() throws Exception {
        MockEventSimRasEventProviderForeignBus.returnNull_ = true;
        new MockEventSimRasEventProviderForeignBus(mock(Logger.class));
    }

    @Test(expected = RuntimeException.class)
    public void getBadStream() throws Exception {
        MockEventSimRasEventProviderForeignBus.loadBad_ = true;
        new MockEventSimRasEventProviderForeignBus(mock(Logger.class));
    }
    ...
    public void actOnData1() {
        MockEventSimRasEventProviderForeignBus actions = new MockEventSimRasEventProviderForeignBus(mock(Logger.class));
    ...
    private EventSimRasEventProviderForeignBus transformer_;
