...
public class RasEventTransformerTest {
    static class MockRasEventTransformer extends RasEventTransformer {
        MockRasEventTransformer(Logger logger) { super(logger); initialize(); }
    ...
    public void setUp() throws Exception {
        MockRasEventTransformer.returnNull_ = false;
        MockRasEventTransformer.loadBad_ = false;
        RasEventTransformer.Accumulator.suppressionCount_ = 3;
        RasEventTransformer.Accumulator.suppressionWindowsSeconds_ = 10;
        transformer_ = new MockRasEventTransformer(mock(Logger.class));
    ...
    public void getStreamFails() throws Exception {
        MockRasEventTransformer.returnNull_ = true;
        new MockRasEventTransformer(mock(Logger.class));
    }

    @Test(expected = RuntimeException.class)
    public void getBadStream() throws Exception {
        MockRasEventTransformer.loadBad_ = true;
        new MockRasEventTransformer(mock(Logger.class));
    }
    ...
    private RasEventTransformer transformer_;
