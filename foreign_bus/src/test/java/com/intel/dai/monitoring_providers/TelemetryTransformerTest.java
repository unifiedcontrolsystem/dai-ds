...
public class TelemetryTransformerTest {
    static class MockTelemetryTransformer extends TelemetryTransformer {
        MockTelemetryTransformer(Logger logger) { super(logger); initialize(); }
    ...
    @Before
    public void setUp() {
        MockTelemetryTransformer.returnNull_ = false;
        TelemetryTransformer.Accumulator.useTime_ = false;
        TelemetryTransformer.Accumulator.count_ = 3;
        TelemetryTransformer.Accumulator.ns_ = 10L;
        TelemetryTransformer.Accumulator.moving_ = false;
        transformer_ = new MockTelemetryTransformer(mock(Logger.class));
    ...
    public void accumulatorCount() {
        TelemetryTransformer.Accumulator accum = new TelemetryTransformer.Accumulator(mock(Logger.class));
    ...
    public void accumulatorMoving() {
        TelemetryTransformer.Accumulator.moving_ = true;
        TelemetryTransformer.Accumulator accum = new TelemetryTransformer.Accumulator(mock(Logger.class));
        CommonDataFormat data = new CommonDataFormat(1000L, "Location", DataType.EnvironmentalData);
        data.setValueAndUnits(1.0, "W", "Power");
        accum.addValue(data);
    ...
    public void accumulatorTime() {
        TelemetryTransformer.Accumulator.useTime_ = true;
        TelemetryTransformer.Accumulator accum = new TelemetryTransformer.Accumulator(mock(Logger.class));
        CommonDataFormat data = new CommonDataFormat(1000L, "Location", DataType.EnvironmentalData);
        data.setValueAndUnits(1.0, "W", "Power");
        accum.addValue(data);
    ...
    public void ctorNegative() {
        MockTelemetryTransformer.returnNull_ = true;
        new MockTelemetryTransformer(mock(Logger.class));
    }
    ...
    private TelemetryTransformer transformer_;
