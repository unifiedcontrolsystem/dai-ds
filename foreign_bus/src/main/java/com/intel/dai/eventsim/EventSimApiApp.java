...
public class EventSimApiApp implements EventSimApi {
    ...
    public void executeRoutes(EventSimApiApp eventsimapi) throws RESTServerException {
        ...
        source_.registerPathCallBack("/wlm/createRes", HttpMethod.POST, eventsimapi::createReservation);
        source_.registerPathCallBack("/wlm/modifyRes", HttpMethod.POST, eventsimapi::modifyReservation);
        source_.registerPathCallBack("/wlm/deleteRes", HttpMethod.POST, eventsimapi::deleteReservation);
        source_.registerPathCallBack("/wlm/startJob", HttpMethod.POST, eventsimapi::startJob);
        source_.registerPathCallBack("/wlm/terminateJob", HttpMethod.POST, eventsimapi::terminateJob);
        source_.registerPathCallBack("/wlm/simulate", HttpMethod.POST, eventsimapi::simulateWlm);
    }
    ...
    @Override
    public String createReservation(Map<String, String> parameters) {
        try {
            eventSimEngine.createReservation(parameters);
            return create_result_json("F", "Success");
    ...
    @Override
    public String modifyReservation(Map<String, String> parameters) {
        try {
            eventSimEngine.modifyReservation(parameters);
            return create_result_json("F", "Success");
    ...
    @Override
    public String deleteReservation(Map<String, String> parameters) {
        try {
            eventSimEngine.deleteReservation(parameters);
            return create_result_json("F", "Success");
    ...
    @Override
    public String startJob(Map<String, String> parameters) {
        try {
            eventSimEngine.startJob(parameters);
            return create_result_json("F", "Success");
    ...
    @Override
    public String terminateJob(Map<String, String> parameters) {
        try {
            eventSimEngine.terminateJob(parameters);
            return create_result_json("F", "Success");
    ...
    @Override
    public String simulateWlm(Map<String, String> parameters) {
        try {
            eventSimEngine.simulateWlm(parameters);
            return create_result_json("F", "Success");
