...
class EventsCliTest(TestCase):
    ...
    def test_ras_events_help(self):
        ...
        self.assertIn('usage: eventsim events ras [-h] [--burst] [--count COUNT] [--delay DELAY]\n                    '
                      ...
                      '--jpath-field JPATH_FIELD]\n                           [--jpath-field-metadata '
                      'JPATH_FIELD_METADATA]\n                           [--jpath-field-metadata-filter '
                      'JPATH_FIELD_METADATA_FILTER]\n\noptional arguments:\n  -h, --help            show this help '
                      'message and exit\n  --burst               generate ras events without delay. Default is '
                      'constant\n                        mode with delay\n  --count COUNT         given number of ras '
                      'events are generated. The default\n                        values exists in eventsim config '
                      'file\n  --delay DELAY         pause for given value in microseconds to generate ras\n          '
                      '              events. The default values exists in eventsim config\n                        '
                      'file\n  --locations LOCATIONS\n                        generate ras events at a given '
                      'location. Provide regex\n                        for multiple locations\n  --output OUTPUT     '
                      '  save data to a file\n  --seed SEED           seed to duplicate data\n  --template TEMPLATE   '
                      'sample template to generate ras events\n  --timeout TIMEOUT     ras sub-command execution '
                      ...
                      '                Provide json-path to field only. Ex:\n                        level0/level1['
                      '*]/item1\n  --jpath-field-metadata JPATH_FIELD_METADATA\n                        Provide file '
                      'path with all possible values. Ex:\n                        /tmp/source.json\n  '
                      '--jpath-field-metadata-filter JPATH_FIELD_METADATA_FILTER\n                        Provide '
                      'regex value to fill data in json-path-field.\n                        Ex: level0/level1['
                      '*]/item1\n', captured_output.getvalue())
        captured_output.close()
    ...
    def test_sensor_events_help(self):
        ...
        self.assertIn('usage: eventsim events sensor [-h] [--burst] [--count COUNT] [--delay DELAY]\n                 '
                      ...
                      '     [--jpath-field-metadata JPATH_FIELD_METADATA]\n                              ['
                      '--jpath-field-metadata-filter JPATH_FIELD_METADATA_FILTER]\n\noptional arguments:\n  -h, '
                      '--help            show this help message and exit\n  --burst               generate sensor '
                      'events without delay. Default is\n                        constant mode with delay\n  --count '
                      'COUNT         given number of sensor events are generated. The\n                        '
                      'default values exists in eventsim config file\n  --delay DELAY         pause for given value '
                      'in microseconds to generate\n                        sensor events. The default values exists '
                      'in eventsim\n                        config file\n  --locations LOCATIONS\n                    '
                      ...
                      '--timeout TIMEOUT     sensor sub-command execution timeout\n  --timezone TIMEZONE   generate '
                      'sensor events for given timezone. The default\n                        values exists in config '
                      'file\n  --type {energy,fabric-perf,power,temperature,voltage}\n                        provide '
                      'type of the sensor event to generate events\n  --jpath-field JPATH_FIELD\n                     '
                      '   Provide json-path to field only. Ex:\n                        level0/level1[*]/item1\n  '
    ...
    def test_boot_events_help(self):
        ...
        self.assertIn('usage: eventsim events boot [-h] [--burst] [--delay DELAY]\n                            ['
                      ...
                      '--help            show this help message and exit\n  --burst               generate boot '
                      'events without delay. Default is\n                        constant mode with delay.\n  --delay '
                      'DELAY         pause for given value in microseconds to generate boot\n                        '
                      'events. The default values exists in eventsim config\n                        file.\n  '
                      '--locations LOCATIONS\n                        generate boot events at a given location. '
                      'Provide\n                        regex for multiple locations.\n  --output OUTPUT       store '
                      'data in a file\n  --probability PROBABILITY\n                        generate boot events with '
                      'probability failure. Default\n                        no failure.\n  --seed SEED           '
                      ...
                      'boot events for given timezone. The default\n                        values exists in config '
                      'file\n  --type {off,on,ready}\n                        generate given type of boot events. '
                      'Default generates\n                        all [on/off/ready] types of boot events.\n  '
                      '--jpath-field JPATH_FIELD\n                        Provide json-path to field only. Ex:\n      '
                      '                  level0/level1[*]/item1\n  --jpath-field-metadata JPATH_FIELD_METADATA\n      '
                      '                  Provide file path with all possible values. Ex:\n                        '
                      '/tmp/source.json\n  --jpath-field-metadata-filter JPATH_FIELD_METADATA_FILTER\n                '
                      '        Provide regex value to fill data in json-path-field.\n                        Ex: '
                      'level0/level1[*]/item1\n', captured_output.getvalue())
        captured_output.close()
