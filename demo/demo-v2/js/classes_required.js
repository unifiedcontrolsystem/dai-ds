...
var colormap = {
    ...
    "compute-node-state-H" : "#808080",
    "compute-node-state-R" : "#00264d",
    "compute-node-state-P" : "#004080",

    "service-node-state-M" : "#000d1a",
    "service-node-state-A" : "#cce5ff",
    "service-node-state-H" : "gray",
    "service-node-state-E" : "red",
    "service-node-state-S" : "#003366",
    ...
    "service-node-state-R" : "#00264d",
    "service-node-state-P" : "#004080",
...
var States = {
    ...
    R: {name: "Bios Reset", description: "Nodes starting BIOS due to a reset"},
    S: {name: "SelectBootDev", description: "Nodes in Selecting Boot Device"},
    P: {name: "Pxe Load NBP", description: "Nodes in PXE downloading NBP file"},
    B: {name: "Bios Starting", description: "Nodes in BIOS Starting"},
